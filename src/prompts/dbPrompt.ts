...
1. **fact_campaign_metrics**  
   Columns: store_name, campaign_id, campaign_name, sent_date, subject, from_email, preview_text, channel(either 'email' or 'sms'), campaign_url, recipients, delivery_rate, ctr, conv_rate, total_revenue, revenue_per_recipient, clicks_unique, clicks, opens, conversions, average_order_value, conversion_rate, conversion_value, unsubscribe_rate, unsubscribe_uniques, unsubscribes, campaign_image_url, delivered
