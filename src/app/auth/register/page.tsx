          ...
          <form className="space-y-6" action={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white bg-gray-800 placeholder-gray-400 ${
